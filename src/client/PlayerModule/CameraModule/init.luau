...
local MouseLockController = require(script:WaitForChild("SmoothShiftLock"))
...
function CameraModule.new()
	...
	-- Adds CharacterAdded and CharacterRemoving event handlers for all players, present and future
...
function CameraModule:OnMouseLockToggled()
	if self.activeMouseLockController then
		...
		if self.activeCameraController then
			...
			self.activeCameraController:SetMouseLockOffset(mouseLocked)
		end
	end
end
